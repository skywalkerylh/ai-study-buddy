...
class QuizManager:
    """
    bridge backend(LLM) and streamlit UI
    1. generate_questions: append all questions to self.questions 
    2. attempt_quiz: show questions 
    3. evaluate_quiz: evaluate user_answers and score 
    4. save_to_csv buttom can save the result 
    """
    def __init__(self):
        self.questions=[]
        self.user_answers=[]
    ...
    def generate_questions(self, generator:QuestionGenerator , topic:str , question_type:str , difficulty:str , num_questions:int):
        ...
        # store all LLM-generated questions in self.questions 
        try:
